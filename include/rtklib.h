...
#ifndef MAXDATA
#define MAXDATA     150                 /* max number of data in a file*/
#endif
...
#define SIGAL_CLOSE       -1
#define SIGAL_IDLE        0
#define SIGAL_ACQ         1
#define SIGAL_HOLD        2
#define SIGAL_REACQ       3
#define SIGAL_OPENLOOP    4
#define SIGAL_PULL        5
#define SIGAL_PULL2       6
#define SIGAL_TRACK       7
#define SIGAL_GOOD        8
#define SIGAL_WEAK        9
#define SIGAL_ASS_TRACK   10
#define SIGAL_ASS_TCKWEAK 11
#define SIGAL_ASS_GOOD    12
#define SIGAL_ASS_WEAK    13
#define SIGAL_ASS_D_TRACK 14
#define SIGAL_ASS_D_GOOD  15

#define BIT_SYNC_FALSE        0
#define BIT_SYNC_TRUE         1
#define FRM_SYNC_CONFIRM      2
#define FRM_SYNC_TRUE         4

#define PHA_UNLLOCK     0
#define PHA_LOCK        1

#define CHXMEAS_INVALID       0
#define CHXMEAS_PROK          1
#define CHXMEAS_CROK          2
#define CHXMEAS_WAITSMPR      3
#define CHXMEAS_SMPROK        4

#define POS_NONE              0
#define POS_FIXEDPOS          1
#define POS_FIXEDHEIGHT       2
#define POS_DOPPLER_VELOCITY  8
#define POS_SIGNLE            16
#define POS_PSRDIFF           17
#define POS_WAAS              18
#define POS_PROPAGATED        19
#define POS_OMNISTAR          20
#define POS_L1_FLOAT          32
#define POS_IONOFREE_FLOAT    33
#define POS_NARROW_FLOAT      34
#define POS_L1_INT            48
#define POS_NARROW_INT        50
#define POS_OMNISTAR_HP       64
#define POS_OMNISTAR_XP       65
#define POS_PPP_CONVERGING    68
#define POS_PPP               69
#define POS_OPERATIONAL       70
#define POS_WARNING           71
#define POS_OUT_OF_BOUNDS     72

#define SAT_POS_NONE          0
#define SAT_POS_SINGLE        1
#define SAT_POS_PSRDIFF       2
#define SAT_POS_RTKFIXED      4
#define SAT_POS_RTKFLOAT      5
#define SAT_POS_SBASSINGLE    9
#define SAT_POS_PPPFLOAT      10
#define SAT_POS_PPPFIXED      11

#define DIREC_FAIL            0
#define DIREC_SUCCESS         1
#define DIREC_NODATA          2
#define DIREC_NOEPH           3
#define DIREC_XYZERROR        4
#define DIREC_OTHER           5

#define SOL_STA_GOOD                0
#define SOL_STA_PV_PREPARING        1
#define SOL_STA_OBS_INSUFFICIENT    2
#define SOL_STA_OLS_FAIL            3
#define SOL_STA_RLS_FAIL            4
#define SOL_STA_RAIM_TAKE_EFFECT    5
#define SOL_STA_POS_JUMP            6
#define SOL_STA_VEL_JUMP            7
#define SOL_STA_NOT_CONVERGENT      8
#define SOL_STA_HGT_ABNORMAL        9
#define SOL_STA_LARGE_RESIDUALS     10
#define SOL_STA_LARGE_GDOP          11
#define SOL_STA_POS_LSM_FAIL        12
#define SOL_STA_VEL_LSM_FAIL        13
#define SOL_STA_LARGE_POSRMS        14
#define SOL_STA_LARGE_VELRMS        15
#define SOL_STA_HEIGHT_ABNORMAL     16
#define SOL_STA_UNKNOWN_ERROR       98
#define SOL_STA_NOT_INIT            99

#define USED_IN_SOLUTION            0
#define MEAS_OK                     1
#define MEAS_FIRST_SOL              9
#define LOW_ELEVATION               11
#define LOW_SNR                     12
#define LARGE_RMS                   13
#define NOT_TRACKED                 19
#define MEAS_NOT_AVAILABLE          20
#define EPH_NOT_AVATIABLE           21
#define EPH_UNHEALTHY               22
#define TIME_FREQ_PARA_WAG          23
#define ALMANAC_HEALTH_NOT_AVAILABLE 24
#define ALM_UNHEALTHY               25
#define ALERT_FLAG_SET              26
#define URA_ABSENCE                 27
#define EXCLUDED_BY_USER            28
#define OLD_EPH                     30
#define NO_DIFFERENTIAL_DATA        31
#define WRG_MEAS_BY_RAIM            32
#define DLL_NOT_SETTLED             34
#define INI_CON_FROM_EPH_WRG        35
#define CAL_SATPVT_FAIL             36
#define PSR_VALAUE_WRG              37
#define PSR_STEP_LARGE              38
#define PSR_SMOOTH_NOT_CONVERGENT   39
#define TIME_NOT_SURE               40
...
extern int satid2prn(const char *id);
...
extern int  lsq   (const double *A, const double *y, int n, int m, double *x,
                   double *Q);
extern int  lsqP  (double *x, double *P, const double *H, const double *v,
...
extern int decode_gpgsa(raw_t *raw);
...
extern int input_hcnoem4f(hcnraw_t *raw,FILE *fp);
...
extern int  rtkpos2 (rtk_t *rtk, const obsd_t *obs, int nobs, const nav_t *nav,
                    double *H,double *R,double *v,dnsat_t *dnsat);
...
extern int postpos(gtime_t ts, gtime_t te, double ti, double tu,
                   ...
                   const char *rov, const char *base,outsol_t *osol);
